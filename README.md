...
<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-8322854770111557"
    ...
    <meta name="google-adsense-account" content="ca-pub-8322854770111557">
...
<body>
    <div class="container">
        ...
        <div class="part">
            ...
            <div class="question">
                <label>e1. Monte um Roteiro de atendimento para Dúvida operacional da ferramenta</label>
                <div class="answer">
                    ...
                    Suporte: "Entendi. Vamos resolver isso agora. Primeiro, acesse Configurações > Respostas Automáticas. Você vê o botão '+' no canto superior direito? [aguarda confirmação]. Clique nele e preencha os campos: Nome da Regra, Palavras-chave e a Mensagem de Resposta. Quer que eu compartilhe minha tela para te mostrar?"
                </div>
            </div>
            
            <div class="question">
                <label>e2. Monte um Roteiro de atendimento para Suporte técnico</label>
                <div class="answer">
        ...
        <div class="part">
            ...
            <div class="question">
                <label>a. Onde o cliente aperta para conectar uma nova conta de API OFICIAL?</label>
                <div class="answer">
            ...
            <div class="question">
                <label>b. Onde o cliente aperta para efetuar disparos em massa para os clientes?</label>
                <div class="answer">
                    O caminho seria: Menu lateral > "Mensagens" > Submenu "Disparos em Massa". Na página que abre, clicar em "Novo Disparo" e selecionar entre os tipos disponíveis (Marketing, Transacional ou Serviço). Alternativamente, dependendo da configuração, pode estar disponível diretamente no dashboard principal através do card "Disparos Rápidos".
                </div>
            </div>
            
            <div class="question">
                <label>c. O cliente deseja adicionar acessos de equipe em sua conta. Onde ele deve clicar?</label>
                <div class="answer">
                    No menu de configurações (ícone de engrenagem no canto inferior esquerdo) > "Gerenciar Acessos" ou "Gestão de Usuários". Lá ele encontraria a opção "Adicionar Membro da Equipe" onde pode inserir o e-mail do colaborador e definir as permissões específicas (Administrador, Operador ou Visualizador).
                </div>
            </div>
            
            <div class="question">
                <label>d. O Cliente pergunta se é possível segmentar e organizar os leads para atendimento. O que você responderia?</label>
                <div class="answer">
                    "Com certeza! O Unnichat oferece várias formas de segmentação: 1) <strong>Tags</strong>: Você pode criar tags personalizadas (ex: 'interessado-em-x', 'cliente-ativo') para classificar contatos; 2) <strong>Listas</strong>: Criar listas segmentadas por características ou comportamentos; 3) <strong>Campos Customizados</strong>: Adicionar campos extras aos contatos (como estágio no funil); 4) <strong>Filtros Avançados</strong>: Combinar múltiplos critérios (última interação, mensagens não lidas, etc). Posso te mostrar na prática como configurar isso?"
                </div>
            </div>
            
            <div class="question">
                <label>e. Onde você iria para entender mais sobre o Unnichat?</label>
                <div class="answer">
                    Há várias opções: 1) No próprio sistema, acessando o menu "Ajuda" (ícone de interrogação) que contém tutoriais em vídeo e artigos; 2) Na Central de Ajuda oficial (normalmente acessível via link no rodapé); 3) Na comunidade de usuários (se houver); 4) Agendando sessões de treinamento com o time de Customer Success; 5) Nos webinars regulares oferecidos pela equipe. Para começar, recomendo explorar a seção "Primeiros Passos" na documentação.
                </div>
            </div>
            
            <div class="question">
                <label>f. Ao analisar essa tela, quais funcionalidades você imagina que o Unnichat tem?</label>
                <div class="answer">
                    Pela análise da interface, deduzo que o Unnichat oferece:<br><br>
                    ...
                    10) <strong>Integrações</strong>: Possível conexão com outros sistemas via API
                </div>
            </div>
        </div>
        ...
        <div class="part">
            ...
            <div class="question">
                <label>a. O que é API Oficial do WhatsApp?</label>
                <div class="answer">
                    A API Oficial do WhatsApp (também chamada de WhatsApp Business API) é a solução desenvolvida pelo próprio WhatsApp/Meta para comunicação empresarial em escala. Diferente das soluções não-oficiais, ela:<br><br>
                    ...
                    É a solução ideal para empresas que precisam de comunicação confiável, escalável e em compliance com as políticas da plataforma.
                </div>
            </div>
            
            <div class="question">
                <label>b. Qual o custo médio de envio da API?</label>
                <div class="answer">
                    O custo varia por:<br><br>
                    ...
                    *Valores aproximados - sujeitos a alterações pelo WhatsApp. Para valores exatos, consultar a tabela oficial do Meta ou o painel do provedor.
                </div>
            </div>
            
            <div class="question">
                <label>c. Qualquer pessoa pode ter uma conta API Oficial?</label>
                <div class="answer">
                    Não exatamente. Há requisitos importantes:<br><br>
                    ...
                    Para pequenos negócios, o WhatsApp Business (app normal) pode ser mais adequado.
                </div>
            </div>
            
            <div class="question">
                <label>d. Conte um pouco sobre sua experiência com API Oficial de WhatsApp.</label>
                <div class="answer">
                    Tenho experiência prática com a API Oficial em diversos cenários:<br><br>
                    ...
                    Um caso interessante foi quando otimizei os templates de uma rede de clínicas, aumentando a taxa de agendamentos via WhatsApp em 40%. Também desenvolvi um manual interno de melhores práticas para evitar bloqueios, baseado nas políticas oficiais e experiência empírica.
                </div>
            </div>
        </div>
    </div>
